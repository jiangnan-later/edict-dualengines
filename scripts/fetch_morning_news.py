...
FEEDS_ZH = {
    '政治': [
        ...
        ('中国新闻网', 'https://www.chinanews.com.cn/rss/world.xml'),
    ...
    '经济': [
        ...
        ('人民网', 'http://www.people.com.cn/rss/finance.xml'),
        ('BBC中文', 'https://feeds.bbci.co.uk/zhongwen/simp/rss.xml'),
    ],
    'AI大模型': [
...
def get_feeds_for_language(lang='zh-CN'):
    """返回指定语言的 RSS 源配置。默认中文优先。"""
...
def main():
    ...
    # 语言配置：默认中文
    display_lang = config.get('display_language', 'zh-CN')
    feeds_for_lang = get_feeds_for_language(display_lang)
    ...
    if config.get('categories'):
        ...
        enabled_cats = set(feeds_for_lang.keys())
    ...
    merged_feeds = {}
    for cat, feeds in feeds_for_lang.items():
